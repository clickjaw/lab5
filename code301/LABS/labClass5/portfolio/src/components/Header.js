  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://www.github.com/clickjaw" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
        ...
        <div className="row aligner" style={{height: '100%'}}>
          <div className="col-md-12">
            <div>
              ...
              <img className = "header-icon" src = "./images/MyProfile.jpg"/>
              <br/>
              <h1 className="mb-0">
                {name}
              </h1>
